  ...
  return (
    <div className="flex flex-col h-full gap-3">
      <Link href={`/products/${product.id}`} className="h-full">
        <div className="group h-full rounded-lg border border-border/40 bg-card/50 backdrop-blur-sm p-6 hover:bg-card hover:border-primary/50 hover:shadow-lg transition-all duration-300 cursor-pointer flex flex-col">
      ...
      <Button onClick={handleAddToCart} className="w-full gap-2" variant={isAdded ? "default" : "outline"}>
